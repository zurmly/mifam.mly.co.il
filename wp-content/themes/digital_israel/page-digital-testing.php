...
<!--                    <p style=" font-size: 24px;">משפט  6/{{questionNum+1}} : {{Questions[page][questionNum]}}</p>-->
              ...
              <div class="answers-bar">
                  <div class="row">
                      <div class="col-5">
                          <div id="answers-num-1" class="answers-num" v-bind:class="{ active: viewSelectedAnswer1}" @click="selectAnswers(1)">1</div>
                      ...
                      <div class="col-5">
                          <div id="answers-num-2" class="answers-num" v-bind:class="{ active: viewSelectedAnswer2}" @click="selectAnswers(2)">2</div>
                          <div class="answers-text">
                              אין לרשות תכנית או אסטרטגיה דיגיטלית, הרשות שוקלת לפתח תכנית כזו
                          </div>
                      </div>
                      <div class="col-5">
                          <div id="answers-num-3" class="answers-num" v-bind:class="{ active: viewSelectedAnswer3}" @click="selectAnswers(3)">3</div>
                          <div class="answers-text">
                              הוגדרה תכנית דיגיטלית, קיימת הבנה לנושא
                          </div>
                      </div>
                      <div class="col-5">
                          <div id="answers-num-4" class="answers-num" v-bind:class="{ active: viewSelectedAnswer4}" @click="selectAnswers(4)">4</div>
                          <div class="answers-text">
                      ...
                      <div class="col-5">
                          <div id="answers-num-5" class="answers-num" v-bind:class="{ active: viewSelectedAnswer5}" @click="selectAnswers(5)">5</div>
                          <div class="answers-text">
  ...
  // alert(magicalData.userID)
    ...
    var vm = new Vue({
        ...
        data: {
            ...
            userAnswersIDS:new Array(),
            saveUserAnswers: new Array(),
            QuestionsIds: '',
            formID:'',
            viewSelectedAnswer1: false,
            viewSelectedAnswer2: false,
            viewSelectedAnswer3: false,
            viewSelectedAnswer4: false,
            viewSelectedAnswer5: false,
            isActive: false
        },
        methods: {
            nextQuestion(){
                if(this.answer != ''){
                    ...
                    // console.log('Questions',this.Questions[this.page].length)
                    if(this.userAnswers.length + 1 == this.Questions[this.page].length){
                        ...
                        var stageUserAnswers = this.userAnswersIDS;
                        ...
                        this.userAnswersIDS[this.questionNum] = answerID;
                        this.userAnswers[this.questionNum] = this.answer;
                        $('#box'+ this.page +' .status-line-' + this.questionNum + '').show();
                        this.clearViewSelected();
                        this.answer = '';
                        this.answerNum++;
                        this.questionNum++;
                        if(this.userAnswers[this.questionNum]){
                            // alert(this.userAnswers[this.questionNum]);
                            this.selectAnswers(this.userAnswers[this.questionNum]);
                        }
                    }
                }else{
            ...
            selectAnswers(val){
                this.answer = val;
                if(val == 1){
                    this.viewSelectedAnswer1 = true;
                    this.viewSelectedAnswer2 = false;
                    this.viewSelectedAnswer3 = false;
                    this.viewSelectedAnswer4 = false;
                    this.viewSelectedAnswer5 = false;
                }
                if(val == 2){
                    this.viewSelectedAnswer1 = false;
                    this.viewSelectedAnswer2 = true;
                    this.viewSelectedAnswer3 = false;
                    this.viewSelectedAnswer4 = false;
                    this.viewSelectedAnswer5 = false;
                }
